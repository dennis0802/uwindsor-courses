//============================================================================
// Name        : signed-arithmetic.c
// Author      : Dennis Dao
// Version     : 1.0
// Description : Program that runs signed-2's complement addition and signed-2's
//				 complement subtraction of two binary numbers inputed by the user.
//				 The user can also decide the base to output the result in.
//============================================================================
...
int main(void){
	...
	while(exit == 0){
		...
		puts("0) EXIT");
		puts("1) Addition in signed-2's complement");
		puts("2) Subtraction in signed-2's complement");
		fflush(stdout);
		scanf("%d", &input);

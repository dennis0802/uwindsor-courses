...
",65:9,58,65:7,-1:16");
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -6:
						break;
					case 6:
						{ return new Symbol(A5Sym.ARITH, yytext()); }
					case -7:
						break;
					case 7:
					...
					case -11:
						break;
					case 11:
						{return new Symbol(A5Sym.BOOL, yytext());}
					case -12:
						break;
					case 12:
    ...
    if(yytext().equals("INT")){
        return new Symbol(A5Sym.TYPE, "int"); 
    }
    else if(yytext().equals("STRING")){
        return new Symbol(A5Sym.TYPE, "String"); 
    }
    return new Symbol(A5Sym.TYPE, "double"); 
}
					case -16:
						break;
					case 16:
    ...
    if(yytext().equals("TRUE")){
        return new Symbol(A5Sym.BOOLVAL, "true");
    }
    return new Symbol(A5Sym.BOOLVAL, "false");
}
					case -21:
						break;
					case 21:
